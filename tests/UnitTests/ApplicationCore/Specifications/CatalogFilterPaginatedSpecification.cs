...
namespace Microsoft.UsedCarDealerWeb.UnitTests.ApplicationCore.Specifications;
...
public class CatalogFilterPaginatedSpecification
{
    ...
    {
        var spec = new UsedCarDealerWeb.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, null, null);
    ...
    {
        var spec = new UsedCarDealerWeb.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, 1, 1);
